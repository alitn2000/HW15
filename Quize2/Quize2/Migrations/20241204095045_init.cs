        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HolderName = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cards", x => x.CardNumber);
                    table.ForeignKey(
                        name: "FK_Cards_Users_HolderName",
                        column: x => x.HolderName,
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserName", "FirstName", "LastName", "NationalId", "Password" },
                values: new object[,]
                {
                    { "alitn", "ali", "tahmasebinia", "0023527676", "123" },
                    { "mamali", "mamad", "mamali", "0023527678", "123" },
                    { "reza", "reza", "rezayi", "0023527677", "123" }
                });

            migrationBuilder.InsertData(
                table: "Cards",
                columns: new[] { "CardNumber", "Balance", "DailyTransferAmount", "HolderName", "IsActive", "Password", "TodayTransaction" },
                values: new object[,]
                {
                    { "5892101407708383", 500000f, 0f, "alitn", true, "123", null },
                    { "5892101407708384", 500000f, 0f, "reza", true, "123", null },
                    { "5892101407708385", 500000f, 0f, "mamali", true, "123", null }
                });
